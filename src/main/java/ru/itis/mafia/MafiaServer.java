...
public class MafiaServer {
    ...
    private static void assignRoles() {
        ...
        for (int i = 0; i < clientHandlers.size(); i++) {
            if (i < mafiaCount) {
                ...
                clientHandlers.get(i).setRole("Мирный житель");
    ...
    private static void startGame() {
        while (!mafiaPlayer.isEmpty() && !peacefulPlayer.isEmpty()) {
            // Фаза ночи
            System.out.println("Ночь настала! Мафия выбирает жертву.");
            ...
            try {
                Thread.sleep(30000); // Время на голосование (30 секунд)
            ...
            // Фаза дня
            System.out.println("День настал! Мирные голосуют.");
